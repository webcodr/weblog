...
assert_contains "$css" '--post-text-color: #414868;'
assert_contains "$css" '--link-color: #1561ca;'
...
assert_contains "$home" 'id="reading-progress"'
assert_contains "$css" '.reading-progress {'
assert_contains "$js" 'setupReadingProgress();'
