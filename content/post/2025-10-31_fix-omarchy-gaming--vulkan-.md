...
It should work immediately after the installation. There's already a GitHub issue with a pull request to solve this, but it's been open for weeks now and it's not clear, when the fix will be merged and released.
...
The HP ZBook Ultra is no gaming notebook, but it has a really powerful APU and is still a quite compact and light device on the level of a 14" MacBook Pro. I don't want a 250 W 4 kg behemoth of a notebook.
